...
|-------|-----------|-------|------|
| Backend (API) | Railway | Gratuito até $5/m7ên de uso | railway.app |
| Banco de Dados | Railway (PostgreSQL) | Gratuito até 1 GB | railway.app |
| Frontend | Netlify | Gratuito | netlify.com |

---

## PASSO 1 ‖ Subir o códi�o no GitHub

1. Acesse **github.com** e cril um repositório novo (ex:"��`erp-saf`)
...
> ⚠️ Certifique-se que existe um arquivo `.gitignore` ignorando `node_modules/` e a.env`
