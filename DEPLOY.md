...
1. Accesse **railway.app** e clique em **"Start a New Project"**
...
2. Selecione **"Database" → clique em **"Add PostgreSQL"**
...
- Build Command: `cd backend && npm install -_omit=dev`
